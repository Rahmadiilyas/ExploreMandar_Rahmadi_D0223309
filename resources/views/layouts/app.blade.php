...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            {{-- wisata --}}
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#wisata" aria-expanded="true" aria-controls="wisata">
                    <i class="fas fa-fw fa-shopping-cart"></i>
                    <span>Wisata</span>
                </a>
                <div id="wisata" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Akses:</h6>
                        <a class="collapse-item" href="{{ route('admin.lihatwisata') }}">Lihat Wisata</a>
                    </div>
                </div>
            </li>
            <!-- Pembayaran -->
